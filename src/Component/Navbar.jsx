        ...
        <div className="flex justify-around items-center py-1 md:py-2">
          ...
          <div className="flex flex-col justify-center items-center">
            <NavLink to={"/"}>
              ...
              <span className="text-xs md:text-sm text-gray-600 mx-auto">হোম</span>
            </NavLink>
          </div>
          ...
          <div className="flex flex-col justify-center  items-center">
            <NavLink to={"/invesment"}>
              <MdOutlineBusinessCenter className="text-gray-400 text-2xl md:text-3xl mx-auto" />
          ...
          <div className="flex flex-col  justify-center items-center">
            <NavLink to={"/ourteam"}>
              <FaUsers className="text-gray-400 text-2xl md:text-3xl mx-auto" />
          ...
          <div className="flex flex-col justify-center  items-center">
            <NavLink to={"/personal"}>
              <HiOutlineUserCircle className="text-gray-400 text-2xl md:text-3xl mx-auto" />
